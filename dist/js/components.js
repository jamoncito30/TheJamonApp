  ...
  return `
    <div class="space-y-5 animate-ios-fade py-4 px-2">
      ...
      <div class="ios-card p-5 rounded-3xl space-y-4 border border-slate-800 shadow-2xl">
        ...
        <!-- Google OAuth Button -->
        <button id="auth-google-btn" class="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white text-xs font-bold transition-all flex items-center justify-center gap-2">
